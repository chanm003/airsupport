...
export class PrintformService {
  ...
  printMsr(msr, lookups, showFieldsLogic, showPanelsLogic) {
    ...
    if (msr.PNForces.length && showPanelsLogic['PNForces'](msr)) {
    ...
    if (msr.DropZones.length && showPanelsLogic['DropZones'](msr)) {
      const columnsSubTable = [
    ...
    if (msr.Vehicles.length && showPanelsLogic['Vehicles'](msr)) {
      const columnsSubTable = [
    ...
    if (msr.Platforms.length && showPanelsLogic['Platforms'](msr)) {
      const columnsSubTable = [
    ...
    if (msr.TargetLocations.length && showPanelsLogic['TargetLocations'](msr)) {
      const columnsSubTable = [
    ...
    if (msr.LandingZones.length && showPanelsLogic['LandingZones'](msr)) {
      const columnsSubTable = [
